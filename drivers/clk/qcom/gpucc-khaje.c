...
static const struct freq_tbl ftbl_gpu_cc_gx_gfx3d_clk_src[] = {
	F(333000000, P_GPU_CC_PLL0_OUT_MAIN, 1, 0, 0),
	F(478000000, P_GPU_CC_PLL0_OUT_MAIN, 1, 0, 0),
	F(613000000, P_GPU_CC_PLL0_OUT_MAIN, 1, 0, 0),
	F(798000000, P_GPU_CC_PLL0_OUT_MAIN, 1, 0, 0),
	F(833000000, P_GPU_CC_PLL0_OUT_MAIN, 1, 0, 0),
	F(993000000, P_GPU_CC_PLL0_OUT_MAIN, 1, 0, 0),
	F(1038000000, P_GPU_CC_PLL0_OUT_MAIN, 1, 0, 0),
	F(1113000000, P_GPU_CC_PLL0_OUT_MAIN, 1, 0, 0),
	F(1127800000, P_GPU_CC_PLL0_OUT_MAIN, 1, 0, 0),
	F(1273000000, P_GPU_CC_PLL0_OUT_MAIN, 1, 0, 0),
	{ }
};
...
static struct clk_rcg2 gpu_cc_gx_gfx3d_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.num_rate_max = VDD_L2_NUM,
		.rate_max = (unsigned long[VDD_L2_NUM]) {
			[VDD_L2_LOWER] = 333000097,
			[VDD_L2_LOW] = 478000000,
			[VDD_L2_LOW_L1] = 63000000,
			[VDD_L2_NOMINAL] = 798088000,
			[VDD_L2_HIGH] = 1038088000,
			[VDD_L2_HIGH_L1] = 1127800000,
			[VDD_L2_HIGH_L2] = 1273000000},
	},
};
